namespace eval ::optrace {
  variable script "D:/Users/Dell/UART _controller/UART _controller.runs/impl_1/uart_tb.tcl"
...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache C:/Users/Dell/AppData/Roaming/Xilinx/Vivado/.Xil/Vivado-20440-DESKTOP-7FN73CL/incrSyn
  set_param power.xpeLogicHierarchyThreshold 50
  set_param power.enableLutRouteBelPower 1
  set_param runs.launchOptions { -jobs 4  }
  open_checkpoint uart_tb_routed.dcp
  set_property webtalk.parent_dir {D:/Users/Dell/UART _controller/UART _controller.cache/wt} [current_project]
  set_property segmented_configuration 0 [current_design]
OPTRACE "read constraints: write_bitstream" START { }
OPTRACE "read constraints: write_bitstream" END { }
OPTRACE "read constraints: write_bitstream" START { }
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi uart_tb.mmi }
OPTRACE "write_device_image setup" END { }
OPTRACE "write_device_image" START { }
  write_device_image -force uart_tb.pdi 
...
OPTRACE "read constraints: write_device_image_post" END { }
  catch {write_debug_probes -quiet -force uart_tb}
  catch {file copy -force uart_tb.ltx debug_nets.ltx}
